...
<img src="img/running.jpg" alt="" style="width: 60%; float: left; margin-right: 40px;"/>

```{=html}
<p><strong>Earth System × AI × Interpretability.</strong> I build data-informed runoff forecasts for the Qinghai–Tibet Plateau, automate remote-sensing pipelines, and prototype interpretable neural operators so we can move between models and field notes quickly.</p>
...
<div class="city-wrapper">
  <div class="city-layer" style="transform: rotate(30deg); transform-origin: 50% 50%;">
